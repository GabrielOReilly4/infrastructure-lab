...
Windows file access is controlled by two separate permission layers:
...
This behavior confirms that unauthorized folders were not visible to the HR user.
...
For testing, the following commands were used instead:
